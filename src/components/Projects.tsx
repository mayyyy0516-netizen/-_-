...
export default function Projects() {
  return <section id="work" className="section work wrap">
    ...
    <div className="section-heading"><h2 data-display-reveal>CATALOG</h2><p>从品牌营销到智能设计系统，<br />探索创意与增长之间的更多可能。</p></div>
    <div className="project-grid">{projects.map((project) => <article key={project.id} className="project-card">
